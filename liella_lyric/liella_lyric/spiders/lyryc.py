...
class LyricSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.uta-net.com/lyricist/28370/"]

    def parse(self, response):
        for i in range(4):
            table = '#list-song > div.row.justify-content-left.mt-lg-4 > div.main.col-sm-12.col-lg-8.flex-grow-1.ms-lg-0.pe-lg-1 > div.row.songlist-table-block.p-3 > div.py-2.p-0.p-lg-2 > table:nth-child(' + str(i+1) + ')'
            for href in response.css(table + ' > tbody > tr > td.sp-w-100.pt-0.pt-lg-2 > a::attr(href)'):
